...
**TO DO helper function for the part above?**
**for the next part, write a function to build a csv file to avoid repeated calls**
...
**TO DO allow passing in vector? or use dshelper?**
```{r mean sd}
