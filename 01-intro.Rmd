...
1. Assuming steps #1, #2 and #3 above are complete, the user calls functions in the `dsSyntheticClient` package to generate a synthetic but non-disclosive data set which is returned to the client side.
...
4. When the analysis script works as required, the user can run it against the real data on the server side.
