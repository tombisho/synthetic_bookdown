...
First we need to build a login object for the server that holds the data. Note that the **dsSynthetic** functions have been written to work with a single connection:
